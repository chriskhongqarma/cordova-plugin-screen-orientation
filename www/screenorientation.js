...
screenOrientation.setOrientation = function (orientation, success, error) {
    orientationMask = window.OrientationLockType[orientation];
    cordova.exec(success, error, 'CDVOrientation', 'screenOrientation', [orientationMask, orientation]);
};
